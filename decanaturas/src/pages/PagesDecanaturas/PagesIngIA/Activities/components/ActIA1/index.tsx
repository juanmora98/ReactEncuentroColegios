...
function ActivityController() {
  ...
  return (
    <React.Fragment>
      <ActivityDescription 
        title="¡Bienvenido a la actividad de Ingeniería en inteligencia artificial!"
        activityTitle="¡Entrenando la IA! Tu primera IA."
        subtitle="¡Logra que la IA aprenda a partir de imagenes!"
        description={
          <React.Fragment>
            <p>
