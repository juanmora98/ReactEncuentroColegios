  ...
  return (
    <React.Fragment>
      <ActivityDescription 
        ...
        activityTitle="Programacion y redes"
        subtitle="¡Resuelve las tres actividades modificando el código!"
        description="En ingeniería de sistemas, te enfrentarás a diversos desafíos relacionados con programas, juegos, redes, aplicaciones y más. Te presentamos 3 actividades que te ayudarán a comprender conceptos clave y a prepararte para los escenarios que podrás encontrar en esta disciplina."
        complement={<h4 className="Title-Center">Actividades completadas {count}</h4>}
      />
