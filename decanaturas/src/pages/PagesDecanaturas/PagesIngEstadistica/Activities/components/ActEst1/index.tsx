...
function ActivityController() {
  ...
  return (
      <React.Fragment>
        <ActivityDescription 
        title="¡Bienvenido a la actividad de Ingeniería estadística!"
        activityTitle="¡Detectives de Datos en Acción! Encuentra los valores a partir de los datos."
        subtitle="¡Resuelve los siguientes problemas para avanzar!"
        description={
          <React.Fragment>
